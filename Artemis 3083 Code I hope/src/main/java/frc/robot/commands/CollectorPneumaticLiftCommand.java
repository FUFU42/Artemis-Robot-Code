...
public class CollectorPneumaticLiftCommand extends CommandBase {
  CollectorSystem collectorSystem;

  /** Creates a new CollectorPneumaticLiftCommand. */
  public CollectorPneumaticLiftCommand(CollectorSystem collectorSystem) {
