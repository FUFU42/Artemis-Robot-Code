...
public class LiftMotorDownFromShooter extends CommandBase {
  FeederSystem feederSystem;
  /** Creates a new LiftMotorDownFromShooter. */
  public LiftMotorDownFromShooter(FeederSystem feederSystem) {
