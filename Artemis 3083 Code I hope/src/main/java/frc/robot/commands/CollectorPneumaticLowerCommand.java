...
public class CollectorPneumaticLowerCommand extends CommandBase {
  CollectorSystem collectorSystem;
    /** Creates a new CollectorPneumaticLowerCommand. */
  public CollectorPneumaticLowerCommand(CollectorSystem collectorSystem) {
